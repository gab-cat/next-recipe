            ...
            <div className="max-w-2xl mx-auto text-left">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link 
                  ...
                  className="flex items-center space-x-2 bg-gray-800 rounded-full border px-6 border-white/10 hover:border-white/50 hover:bg-gray-700 text-white py-2 transition-colors duration-300"
                >
                ...
                <Link 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="flex items-center space-x-2 bg-blue-600/20 hover:bg-blue-600/50 border border-white/10 hover:border-white/50 text-white px-6 py-2 rounded-full transition-colors duration-300"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
