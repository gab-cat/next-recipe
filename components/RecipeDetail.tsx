        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="relative mb-8 animate-fade-in">
            <div className="relative h-[60vh] rounded-xl overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900">
              ...
              <div className="absolute top-6 left-6">
                ...
                <Badge className="bg-primary/60 text-white backdrop-blur-sm border border-white/30">
              ...
              <div className="absolute top-6 right-6">
                <div className="w-14 h-14 bg-primary/20 backdrop-blur-sm rounded-2xl flex items-center justify-center border border-primary/30">
              ...
              <div className="absolute bottom-0 left-0 right-0 p-8">
                <div className="max-w-4xl">
                  <h1 className="text-5xl lg:text-7xl font-black text-white mb-4 leading-tight tracking-tight">
                    {recipe.name}
                  </h1>
                  ...
                  <div className="flex flex-wrap gap-4">
                    <div className="flex items-center space-x-3 bg-gray-900/60 backdrop-blur-sm px-6 py-3 rounded-2xl border border-gray-700">
                      <Clock className="w-5 h-5 text-primary" />
                      <span className="text-white font-semibold">{recipe.cookingTime}</span>
                    </div>
                    <div className="flex items-center space-x-3 bg-gray-900/60 backdrop-blur-sm px-6 py-3 rounded-2xl border border-gray-700">
                      <Users className="w-5 h-5 text-accent" />
                      <span className="text-white font-semibold">{recipe.servings} servings</span>
                    </div>
                    <div className="flex items-center space-x-3 bg-primary/20 backdrop-blur-sm px-6 py-3 rounded-2xl border border-primary/30">
                      <Play className="w-5 h-5 text-primary" />
                      <span className="text-primary font-semibold">{recipe.instructions.length} steps</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700 p-6 sticky top-32 animate-slide-up">
                <div className="flex items-center mb-6">
                  <div className="w-12 h-12 bg-primary/20 rounded-2xl flex items-center justify-center mr-3 border border-primary/30">
                ...
                <div className="space-y-2">
                  {recipe.ingredients.map((ingredient, index) => (
                    ...
                    >
                      ...
                      >
                        {checkedIngredients.includes(index) && <CheckCircle className="w-3 h-3 text-white" />}
                      </div>
                      <span
            ...
            <div className="lg:col-span-2">
              <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700 p-6 animate-slide-up">
                <div className="flex items-center mb-6">
                  <div className="w-12 h-12 bg-accent/20 rounded-2xl flex items-center justify-center mr-3 border border-accent/30">
                ...
                <div className="space-y-4">
                  {recipe.instructions.map((instruction, index) => (
                    <div
                      key={index}
                      className={`flex items-start p-4 rounded-xl cursor-pointer transition-all duration-300 border ${
                    ...
                    >
                      <div
                        className={`w-12 h-12 rounded-xl flex items-center justify-center mr-4 font-bold text-base transition-all duration-300 border ${
                          completedSteps.includes(index)
                      ...
                      >
                        {completedSteps.includes(index) ? <CheckCircle className="w-6 h-6" /> : index + 1}
                      </div>
                ...
                {completedSteps.length === recipe.instructions.length && (
                  <div className="mt-6 p-6 bg-gradient-to-br from-primary to-accent rounded-3xl text-center animate-scale-in border border-accent/30 shadow-2xl shadow-accent/20">
                    <div className="text-gray-900">
                      <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center mx-auto mb-4">
                        <CheckCircle className="w-10 h-10 text-gray-900" />
                      </div>
                      <h3 className="text-3xl font-black mb-3">Congratulations!</h3>
                      <p className="text-lg font-medium">You&apos;ve completed this amazing recipe! 🎉</p>
                    </div>
                  </div>
                )}
                ...
                <div className="mt-6 pt-4 border-t border-gray-700">
                  <div className="flex items-center justify-between mb-3">
                    ...
                    <Button
                      ...
                      variant="outline"
                      className="border-primary text-primary hover:bg-primary hover:text-white bg-transparent rounded-xl text-sm px-4 py-2"
                    >
                      Reset Progress
                    </Button>
                  </div>
